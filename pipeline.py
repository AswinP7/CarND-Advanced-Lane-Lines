...
class Pipeline:
    ...
    def process(self,img) :
        ...
        cv2.putText(img,"Radius of Curvature:  "+ '{:6.2f}km'.format(curvature), (430,660), cv2.FONT_HERSHEY_SIMPLEX,1.0,[0,0,255],2, cv2.LINE_AA)
        (ll,lr,caroff) = cv.lanepos(l,r)
        cv2.putText(img,"Distance from Center: "+ '{:6.2f}cm'.format(caroff*100), (430,700), cv2.FONT_HERSHEY_SIMPLEX,1.0,[0,0,255],2, cv2.LINE_AA)
