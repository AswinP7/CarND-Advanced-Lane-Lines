...
class CameraClibrationTest(unittest.TestCase):
    ...
    def test_01_calibrateCameraFromDir(self):
        ret, mtx, dist, rvecs, tvecs = uut.calibrateCameraFromDir(CAMERA_CAL_DIR)
        print(ret)
        print(mtx)
        print(dist)
    ...
    def test_03_distort(self):
        ...
        for i,img in enumerate(imgs):
            ...
            image_util.saveBeforeAfterImages(img, "Original", dimg, "Undistorted", TEST_OUT_DIR+"/"+str(i)+"_undistorted.png")
